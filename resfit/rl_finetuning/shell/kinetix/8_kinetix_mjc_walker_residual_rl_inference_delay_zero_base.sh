#!/bin/bash
# Residual TD3 on Kinetix mjc_walker with inference delay 4 and zero base action in env.
...
python -m resfit.rl_finetuning.scripts.train_residual_td3 \
    ...
    wandb.name=residual-rl-kinetix-mjc-walker-delay4-zero-base \
    wandb.notes="kinetix/mjc_walker residual TD3 with inference delay 4 and zero base action in env" \
