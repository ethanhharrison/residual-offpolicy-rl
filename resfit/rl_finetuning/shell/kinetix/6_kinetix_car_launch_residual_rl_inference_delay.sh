#!/bin/bash
# Residual TD3 on Kinetix car_launch with simulated base-policy inference delay.
...
python -m resfit.rl_finetuning.scripts.train_residual_td3 \
    ...
    wandb.name=residual-rl-kinetix-car-launch-delay4 \
    wandb.notes="kinetix/car_launch residual TD3 with inference delay 4" \
