#!/bin/bash
# Residual TD3 on Kinetix mjc_walker with simulated base-policy inference delay.
...
python -m resfit.rl_finetuning.scripts.train_residual_td3 \
    ...
    wandb.name=residual-rl-kinetix-mjc-walker-delay4 \
    wandb.notes="kinetix/mjc_walker residual TD3 with inference delay 4" \
